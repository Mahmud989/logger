...
import static com.mb.tool.model.constant.LogConstants.CONFIDENTIAL_HIDE;
import static com.mb.tool.model.constant.LogConstants.CONFIDENTIAL_REMARK;
import static com.mb.tool.model.constant.LogConstants.LOG_FIELD_DEEP_READ;
        ...
        if (logField == null || LOG_FIELD_DEEP_READ == logField.type()) {
            for (var field : parentObject.getClass().getDeclaredFields()) {
                ...
                if (annotation != null) {
                    ...
                    if (value != null) {
                        var isJavaDefaultClass = value.getClass().getPackageName().startsWith("java.") || value.getClass().getPackageName().startsWith("org.spring");
                        if (!isJavaDefaultClass) {
